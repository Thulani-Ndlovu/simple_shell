...
* @av: argument vector
* Return: 0 (successful), otherwise 1 (failed)
*/
...
* Return: -1 if builtin not found, 0 (successful), 1 if found but not
* success, 2 if the builtin signal exit
*/
...
/**
* fork_cmd - fork an executive thread for running the cmd
* @_info: information struct
*/
